  ...
  while row < 15:
    ...
    while square < 24:
      ...
      if point in data:
        ...
        grid_code += ('<button style="background-color:rgba(255,' + str(green) + ', 0, 0.75);" class="square-button" data-html="true" data-placement="auto right" title="<p class="box-title"><b>' +
                      data[point]['coordinates'] + '</b></p>" data-toggle="popover" data-trigger="focus" data-content="<b>Wind Speed 100m (m/s):</b> ' +
