  ...
  while row < 15:
    ...
    while square < 24:
      ...
      if point in data:
        ...
        grid_code += ('<button style="background-color:rgba(255,' + str(green) + ', 0, 0.6);" class="square-button" data-html="true" data-placement="auto right" title="' +
      ...
      #else:
        #grid_code += '<div style="background-color:rgba(200, 200, 200, 0.15);" class="square-button-empty"></div>'
      grid_code += '</td>'
      square += 1
    grid_code += '</tr>'
    square = 0
