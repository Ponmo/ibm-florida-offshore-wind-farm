...
def render_main():
  ...
  while row < 15:
    ...
    while square < 24:
      ...
      if point in data:
        green = str(1 / float(data[point]['200wind']) * 1650)
        grid_code += ('<button style="background-color:rgba(255,' + green + ', 0, 0.3);" class="square-button" data-html="true" data-placement="auto right" title="' +
