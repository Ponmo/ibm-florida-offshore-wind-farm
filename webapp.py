  ...
  while row < 15:
    ...
    while square < 24:
      ...
      if point in data:
        ...
        grid_code += ('<a tabindex="0" role="button" style="background-color:rgba(255,' + str(green) + ', 0, 0.75);" class="square-button" data-html="true" data-placement="auto right" title="<strong>' +
                      ...
                      '" data-toggle="popover" data-trigger="focus" data-content="popover">' + value + '</a></td>')
        grid_code_basic += ('<button style="background-color: transparent;" class="square-button" data-html="true" data-placement="auto right" title="<strong>' +
                            ...
                            str(data[point]['200wind']) + '<br><b>Wind Speed 150m (m/s):</b> ' + str(data[point]['150wind']) + '<br><b>Wind Speed 100m (m/s):</b> ' + 
                            str(data[point]['100wind']) + '<br><b>Depth (m):</b> ' + str(data[point]['depth']) +
                            '" data-toggle="popover" data-content="popover">' + value + '</button></td>')
      else:
        value = ''
        if row == 0 and square == 0:
          value = 'A1'
